...
namespace Exercises
{
    public partial class Exercises
    {
        ...
        {
             Dictionary<string, string> dictionaryOfPairedItems = new Dictionary<string, string>();

            foreach (string word in words)
            {
                dictionaryOfPairedItems[word.Substring(0, 1)] = (word.Substring(word.Length - 1));
            } 
            return dictionaryOfPairedItems;
        }
    }
}