...
SELECT name, population FROM city WHERE countrycode = 'USA' AND population > 1000000 AND district = 'TEXAS';
...
SELECT gnp, population, (gnp / population)*1000000 AS per_capita_gnp FROM country WHERE continent = 'EUROPE';
