    ...
    public class ExerciseTests
    {
        ...
        */
        ...
        public void distinctValues()
        {
            ...
            CollectionAssert.AreEqual(new List<string>() { "red", "yellow", "green", "blue", "purple" }, exercises.DistinctValues(new List<string>() { "red", "yellow", "green", "yellow", "blue", "green", "purple" }));
            CollectionAssert.AllItemsAreUnique(exercises.DistinctValues(new List<string>() { "jingle", "bells", "jingle", "bells", "jingle", "all", "the", "way" }));
            CollectionAssert.AreEqual(new List<string>() { "jingle", "bells", "all", "the", "way" }, exercises.DistinctValues(new List<string>() { "jingle", "bells", "jingle", "bells", "jingle", "all", "the", "way" }));
        }
